...
execute as @e[type=exposure:photograph_frame] if score @s function_vote_mapcode = $A function_vote_mapcode at @s run particle flame ~ ~1.4 ~0.05 1 0 0 0 1 force @a
execute as @e[type=exposure:photograph_frame] if score @s function_vote_mapcode = $A function_vote_mapcode at @s run particle flame ~ ~1.4 ~0.05 -1 0 0 0 1 force @a
